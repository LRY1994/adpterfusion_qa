...
def get_args():
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="Number of start groups when partitioning graph ",
    )
    parser.add_argument(
        "--sub_group_idx",
        default=None,
...
if __name__ == "__main__":
    ...
    args = get_args()
    # 1. Start a W&B run
    os.environ["WANDB_API_KEY"] = "04742632c4bee2219ed17367f6ec9e6b859e59b2"
    ...
    strt = args.model_str + '_' + str(args.n_partition) + '_' + str(args.triple_per_relation) + '_' + str( args.prefix_length) + '_' + str( args.prompt_length) + '_' +str(args.use_prompt)
    args.save_path = args.output_dir + '/' + strt #+ timestamp_str
    ...
    for group_idx in range(args.n_partition_start ,args.n_partition):
